          ...
          <FlatGrid
            ...
            renderItem={({ item }) => (
              <View>
                ...
                <Text  style={styles.timeAgo_pre_text}>snapped: <TimeAgo time={item.created_at} style={styles.timeAgo_text}/></Text>
                  
                  <View style={styles.height_details}>
                    {/* <PlantHeightIcon width={25} height={25} fill="green" /> */}
                    <Text style={styles.height_pre_text}>plant height:<Text style={styles.height_text}>{item.height}</Text></Text>
                  </View>
                </View>
              </View>
            )}
