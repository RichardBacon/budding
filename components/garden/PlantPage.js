      ...
      {!fontLoading && (
        ...
        >
          ...
          onPress={() => {
            ...
            Alert.alert(`Delete ${plant_name}`, `Are you sure you want to permanently delete ${plant_name}?`, [
            ...
            {text: 'Yes, delete!', onPress: () => {
              ...
              if (response.status === 204) {
                Alert.alert('Plant deleted!', `Successfully deleted ${plant_name}`);
                navigation.navigate('garden')
                // plant name deleted
              } else {
                Alert.alert('Unsuccessful', `Could not delete ${plant_name} - please try again`)
